...
public class WatchToPhoneService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        Log.d(TAG, "Watch to Phone onCreate called");
        ...
        mApiClient = new GoogleApiClient.Builder( this )
                ...
                .addConnectionCallbacks(new GoogleApiClient.ConnectionCallbacks() {
                    ...
                    public void onConnected(Bundle connectionHint) {
                        Log.d(TAG, "Watch to Phone Connection Successfull!");
                    }
                ...
                .addOnConnectionFailedListener(new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(ConnectionResult connectionResult) {
                        Log.d(TAG, "Watch to Phone Connection Failed: " + connectionResult.getErrorMessage());
                    }
                })
                .build();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.d(TAG, "Watch to Phone onStartCommand called");
        Bundle extras = intent.getExtras();
        final String pos = extras.getString("POSITION");
